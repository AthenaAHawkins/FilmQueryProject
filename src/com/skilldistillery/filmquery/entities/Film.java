...
public class Film {
	...
	public Film(int id, String filmName, String description, int released, String language, String rating) {
		this.id = id;
		this.title = filmName;
		this.description = description;
		this.release_year = released;
	...
	public String toString() {
		return "\n\n Film Id: " + id + "\n Movie Title: " + title + "\n Rating: "+ rating + "\n Description: " + description +
				"\n Release year: " + release_year +  " Language: " + language
				+ "\n Actors: " + actors + "\n";
	}

	@Override
	public int hashCode() {
		return Objects.hash(actors, description, first_name, id, language, language_id, last_name, length, rating,
				release_year, rental_duration, rental_rate, replacement_cost, special_features, title);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(actors, other.actors) && Objects.equals(description, other.description)
				...
				&& Objects.equals(last_name, other.last_name) && length == other.length
